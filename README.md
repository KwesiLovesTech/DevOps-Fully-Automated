...
1) ###### GitHub setup
    Fork GitHub Repository by using the existing repo "devops-fully-automated" (https://github.com/KwesiLovesTech/DevOps-Fully-Automated.git)     
    - Go to GitHub (github.com)
    - Login to your GitHub Account
    - **Fork repository "devops-fully-automated" (https://github.com/KwesiLovesTech/DevOps-Fully-Automated.git) & name it "devops-fully-automated"**
...
2) ###### Jenkins/Maven/Ansible
    ...
    - User data (Copy the following user data): https://github.com/KwesiLovesTech/DevOps-Fully-Automated/blob/main/Installations/jenkins-maven-ansible-setup.sh
    - Launch Instance
...
3) ###### SonarQube
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/KwesiLovesTech/DevOps-Fully-Automated/blob/main/Installations/sonarqube-setup.sh
    - Launch Instance
...
4) ###### Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/KwesiLovesTech/DevOps-Fully-Automated/blob/main/Installations/nexus-setup.sh
    - Launch Instance
...
5) ###### EC2 (Dev/Stage/Prod)
    ...
    - Security Group (Open): 8080, 9100 and 22 to 0.0.0.0/0
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/KwesiLovesTech/DevOps-Fully-Automated/blob/main/Installations/deployment-servers-setup.sh
    - Launch Instance
...
6) ###### Prometheus
    ...
    - User data (Copy the following user data): https://github.com/KwesiLovesTech/DevOps-Fully-Automated/blob/main/Installations/prometheus-setup.sh
    - Launch Instance
...
7) ###### Grafana
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/KwesiLovesTech/DevOps-Fully-Automated/blob/main/Installations/grafana-setup.sh
    - Launch Instance
  
8) ###### Slack workspace invite and configuring the token
    - **Join the slack channel [here](https://join.slack.com/t/kwesilovestech/shared_invite/zt-2j7kjzaon-UPyRzaVeQ4PK8xc~NZhBQQ)**
...
To get a comprehensive view of the entire flow and understand the integrations, access the appropriate environment (development, staging, or production) in a separate tab by navigating to:

http://replace-public-ip:8080/webapp
